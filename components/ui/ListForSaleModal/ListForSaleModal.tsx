...
const ListForSaleModal: FC<Props> = ({ open, setOpen, IDs }) => {
  const [selectedID, setSelectedID] = useState(IDs != null ? IDs[0] : "")
  const [price, setPrice] = useState()

  const { fetchUserChests, getAllChestSaleOffers } = useUser()
              ...
              >
                <Container>
                  ...
                  <div style={{ color: "white" }}>
                    ...
                    whitelist. You will no longer be able to purchase more
                    chests from the black market.
                  </div>
                </Container>
              </DialogPanel>
            </Transition.Child>
